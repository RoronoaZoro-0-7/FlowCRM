...
(()=>{
    const e = new Error("Cannot find module '@/frontend/contexts/auth-context'");
...
(()=>{
    const e = new Error("Cannot find module '@/frontend/components/ui/skeleton'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
_s(RootPage, "hfJApfKdkCGjZCs1NVF94JuC2xc=", false, function() {
    return [
        useAuth,
